...
# ---------- sub-pages ----------
const PAGES := {
	"ITEMS":  preload("res://Kevin/pages/EquipPage.tscn"),
	"SKILLS": preload("res://Kevin/pages/SkillsPage.tscn"),
	"SYSTEM": preload("res://Kevin/pages/SystemPage.tscn")
}
...
func _unhandled_input(e: InputEvent) -> void:
	...
	if e.is_action_pressed("ui_down") or e.is_action_pressed("ui_down"):
		...
		_move(-1)
	elif e.is_action_pressed("ui_cancel") or e.is_action_pressed("ui_accept") or e.is_action_pressed("ui_right") or e.is_action_pressed("ui_cancel"):
		_enter_current_page()
	elif e.is_action_pressed("ui_cancel") or e.is_action_pressed("ui_cancel"):
		queue_free()
